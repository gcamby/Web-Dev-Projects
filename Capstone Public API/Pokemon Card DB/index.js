...
app.get("/", async (req,res) => {
  try { 
    ...
    console.log(imageCardPool);
    res.render("index.ejs", { randCard: randCard, latestSet: fullSetList[fullSetList.length-1], imageCardPool: imageCardPool});/* renders the site with cardPool loaded */
  } catch (error) {
